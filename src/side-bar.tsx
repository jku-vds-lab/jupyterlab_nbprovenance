"use strict";
import {IApplicationExtra, IApplicationState, EventType, NotebookProvenance} from "./notebook-provenance";
...
export function provVisUpdate(prov: Provenance<IApplicationState, EventType, IApplicationExtra>) {
...
function createEventConfig<E extends string>(prov: Provenance<unknown, string, unknown>): EventConfig<E> {
  ...
  conf[EventType.activeCell].bundleGlyph = conf[EventType.activeCell].backboneGlyph;
  conf[EventType.activeCell].regularGlyph = conf[EventType.activeCell].backboneGlyph;
  ...
  conf[EventType.executeCell].bundleGlyph = conf[EventType.executeCell].backboneGlyph;
  conf[EventType.executeCell].regularGlyph = conf[EventType.executeCell].backboneGlyph;
  ...
  conf[EventType.removeCell].bundleGlyph = conf[EventType.removeCell].backboneGlyph;
  conf[EventType.removeCell].regularGlyph = conf[EventType.removeCell].backboneGlyph;
  ...
  conf[EventType.moveCell].regularGlyph = conf[EventType.moveCell].backboneGlyph;
  ...
  conf[EventType.changeCellValue].bundleGlyph = conf[EventType.changeCellValue].backboneGlyph;
  conf[EventType.changeCellValue].regularGlyph = conf[EventType.changeCellValue].backboneGlyph;
  conf[EventType.changeCellValue].description = "The value of a cell has been changed";
